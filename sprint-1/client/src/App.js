...
export default class App extends Component {
  ...
  pushComment = (comment, mainVid) => {
    // this.state.mainVideo.comments.concat(comment);

    mainVid.comments = this.state.mainVideo.comments.concat(comment);
  ...
  render() {
    console.log("rendered called", this.state);
    return (
      <div>
        <Nav />
